...
// Type: PackageInspector.DeploymentDriverElement
...
{
  public class DeploymentDriverElement : IAttributeType, ISearchProvider
  {
    ...
    public string SearchPath
    {
      get
      {
        return "Driver - " + string.Format((IFormatProvider) CultureInfo.InvariantCulture, "{0}, {1}, {2}, {3}, {4}", (object) this.AssemblyIdentity.Name, (object) this.AssemblyIdentity.Version, (object) this.AssemblyIdentity.Architecture, (object) this.AssemblyIdentity.Language, (object) this.AssemblyIdentity.VersionScope);
      }
    }
    ...
    public DeploymentDriverElement(IXPathNavigable navigator)
    {
      if (navigator == null)
