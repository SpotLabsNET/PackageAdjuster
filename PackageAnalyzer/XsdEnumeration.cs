...
// Type: PackageInspector.XsdEnumeration
...
{
  public class XsdEnumeration : ISearchProvider
  {
    ...
    public XsdEnumeration(IXPathNavigable navigator)
    {
      if (navigator == null)
