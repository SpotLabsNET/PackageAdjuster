...
// Type: PackageInspector.XsdMaxInclusive
...
{
  public class XsdMaxInclusive : ISearchProvider
  {
    ...
    public string SearchPath
    {
      get
      {
        return "MaxInclusive, " + this.Value;
      }
    }
    ...
    public XsdMaxInclusive(IXPathNavigable navigator)
    {
      if (navigator == null)
    ...
    private void PopulateSearchItems()
    {
      ...
      this.Keywords.Add("maxInclusive");
