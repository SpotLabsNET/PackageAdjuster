...
// Type: PackageInspector.MumAssemblyIdentityElement
...
{
  public class MumAssemblyIdentityElement : AssemblyIdentityElement, ISearchProvider
  {
    ...
    public string SearchPath
    {
      get
      {
        return "Mum Assembly Identity - " + string.Format((IFormatProvider) CultureInfo.InvariantCulture, "{0}, {1}, {2}, {3}, {4}", (object) this.Name, (object) this.Version, (object) this.Architecture, (object) this.Language, (object) this.VersionScope);
      }
    }
    ...
    public MumAssemblyIdentityElement(IXPathNavigable navigator)
      : base(navigator)
    {
      if (navigator == null)
